...
cat $SRCDIR/js/gooda/{Notification,Columns,FileLoader,EventTable,CFGPane,DataView,FunctionView,HotspotView,ContainerView,HelpPane,Report,Visualizer,load}.js \
